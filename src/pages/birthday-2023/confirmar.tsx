...
const BirthdayConfirm: React.FC<{ guests: any[]; apiURL: string }> = ({
  guests,
  apiURL,
}) => {
  ...
  useEffect(() => {
    const localToken = localStorage.getItem(
      LocalStorageEnum.EAS_BIRTHDAY_2023_QUIZ
    );
            ...
            <section className="flex justify-between items-start flex-wrap text-white text-xl pt-[150px] max-[500px]:pt-[230px]">
              <div className="w-full lg:w-1/2 max-2xl:mx-auto">
                <div className="w-full flex flex-col gap-4 justify-start items-start">
                  <p>
                    Hello my friend, espero que esteja bem! Difícil a charada?
                    hehe
                  </p>
                  <p>
                    Esse ano completo os tão famosos{" "}
                    <span className="text-purple font-extrabold">30 anos</span>{" "}
                    e quero muito a sua presença na comemoração!
                  </p>
                  <p>
                    Para quem já foi nas anteriores, vou seguir com o mesmo
                    plano, aluguei uma casa legal, vou fazer as compras dos
                    comes & bebes, e pagar parte do aluguel com o dinheiro
                    arrecadado.
                  </p>
                  <p>
                    Estou torcendo para que saia um sol, pois vai rolar uma
                    praia! k3
                  </p>
                </div>
                <h2 className="text-center text-2xl font-bold mt-10 mb-14">
                ...
                <ul className="flex justify-around items-center gap-6 flex-wrap">
                  <li>
                    <SimpleCard
                      ...
                      label="20-22 de Out (sex-dom)"
                    />
                  </li>
                  <li>
                    <SimpleCard
                      icon="icon-umbrella-beach-solid"
                      label="Praia de São Sebastião"
                    />
                  </li>
                  <li>
                    <SimpleCard
                      icon="icon-burger-solid"
                      label="Open Food and Drinks"
                    />
                  </li>
                  <li>
                    <SimpleCard
                      icon="icon-users-solid"
                      label="Máx. 12 Convidados"
                    />
                  </li>
                  <li>
                    <SimpleCard
                ...
                <div className="text-center mt-10 flex flex-col gap-4 justify-center items-center">
                  ...
                  <p className="text-xl font-semibold">
                    O valor total são de{" "}
                    <strong className="text-purple">R$500 </strong> por pessoa,
                    pagos até a data final de{" "}
                    <strong className="text-purple">06 de Out</strong>.
                  </p>
                  <p>
                    Podem parcelar em quantas vezes forem necessárias até
                ...
                <div className="text-center mb-10">
                  <p>
                    Essa será última que vou realizar devido minha futura trip,
                    espero você lá! de coração s2
                  </p>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2 lg:pl-6 flex flex-col gap-8 text-center max-2xl:mx-auto mb-6">
                ...
                <div className="w-full max-w-[400px] text-left mx-auto">
                  ...
                  <div className="relative w-full mt-4">
                    ...
                    />
                    <button
                      className="w-full text-white bg-dark-purple px-4 py-2 h-10 rounded-lg font-bold mt-6"
                  ...
                  <div className="mt-20 text-center ">
                    Se a lista atingir 12 pessoas ou chegar a data final de
                    29/09 não será mais possível confirmar a sua presença #pokas
                  </div>
                  <p className="text-base mt-4 text-center">
                    Esse nome / apelido vai ser usuado para acessar as
                    informações após confirmação!
                  </p>
                </div>
              </div>
            </section>
